...
(function () {
    ...
    const SERVICE_MAP = {
        ...
        'financial instruments': { id: 'financial-instruments', label: 'Financial Instruments', href: buildHref('service-financial-instruments-overview.html'), icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 20V10"/><path d="M12 20V4"/><path d="M6 20v-6"/></svg>' },
        'financial statements': { id: 'financial-statements', label: 'Financial Statements', href: buildHref('service-financial-statements-overview.html'), icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 12h18"/><path d="M12 3v18"/></svg>' },
