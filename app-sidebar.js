...
(function () {
    ...
    const mainNavItems = [
        ...
        },
        {
            ...
            onclick: "event.preventDefault();if(typeof toggleClientListPanel==='function')toggleClientListPanel();else window.location.href='clients.html';",
...

        {
            id: 'tools',
            label: 'GST Tools',
            href: 'tool-document-reader.html',
        ...
        },
        {
            ...
            label: 'AI Agents',
            href: 'ai-agents.html',
            icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 8V4H8"/><rect x="2" y="2" width="20" height="8" rx="2"/><rect x="2" y="14" width="20" height="8" rx="2"/><path d="M6 18h.01"/><path d="M10 18h.01"/></svg>',
            badge: 'NEW',
            badgeStyle: 'background:linear-gradient(135deg,#6366f1,#8b5cf6);color:#fff;font-size:0.55rem;padding:1px 5px;'
        }
    ];
